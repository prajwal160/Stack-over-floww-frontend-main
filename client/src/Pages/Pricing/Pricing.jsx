                ...
                <div class="row" style={{ textAlign: "center" }}>
                    <div class="col-lg-4">
                        <Card style={{ width: '18rem', borderColor: "rgb(245, 149, 6)", boxShadow: "rgba(0, 0, 0, 0.25) 0px 54px 55px,rgba(0, 0, 0, 0.12) 0px -12px 30px, rgba(0, 0, 0, 0.12) 0px 4px 6px,rgba(0, 0, 0, 0.17) 0px 12px 13px, rgba(0, 0, 0, 0.09) 0px -3px 5px" }}>
                            ...
                            <Card.Body>
                                <Button onClick={() => { if (User !== null) { setAbc(true); setTimeout(() => { setAbc(false) }, 20000) } }} style={{ backgroundColor: "white", border: "none" }}><Button variant='success' onClick={handlefree}>Try Free</Button></Button>
                            </Card.Body>
                        </Card>
                    </div>
                    <div class="col-lg-4">
                        <Card style={{ width: '18rem', borderColor: "#F08080", boxShadow: "rgba(0, 0, 0, 0.25) 0px 54px 55px,rgba(0, 0, 0, 0.12) 0px -12px 30px, rgba(0, 0, 0, 0.12) 0px 4px 6px,rgba(0, 0, 0, 0.17) 0px 12px 13px, rgba(0, 0, 0, 0.09) 0px -3px 5px" }}>

                            <span style={{ fontSize: "20px", textAlign: "center", backgroundColor: "rgb(192, 192, 192)", color: "blue" }}>Recommended</span>
                            ...
                            <Card.Body>
                                <Button onClick={() => { if (User !== null) { setAbc(true); setTimeout(() => { setAbc(false) }, 20000) } }} style={{ backgroundColor: "white", border: "none" }}><Button variant='success' onClick={handlesilver}>Get Premium</Button></Button>
                            </Card.Body>
                        </Card></div>
                    <div class="col-lg-4">
                        <Card style={{ width: '18rem', borderColor: "rgb(245, 149, 6)", boxShadow: "rgba(0, 0, 0, 0.25) 0px 54px 55px,rgba(0, 0, 0, 0.12) 0px -12px 30px, rgba(0, 0, 0, 0.12) 0px 4px 6px,rgba(0, 0, 0, 0.17) 0px 12px 13px, rgba(0, 0, 0, 0.09) 0px -3px 5px" }}>
                            ...
                            <Card.Body>
                                <Button onClick={() => { if (User !== null) { setAbc(true); setTimeout(() => { setAbc(false) }, 20000) } }} style={{ backgroundColor: "white", border: "none" }}><Button variant='success' onClick={handlegold}>Get Premium</Button></Button>
                            </Card.Body>
                        </Card></div>
                </div>
            </div>
